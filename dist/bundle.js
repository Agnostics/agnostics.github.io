	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'logo' },
	                        _react2.default.createElement('img', { src: '\\src\\components\\header\\logo.svg' }),
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'name' },
	                            'BRANDON ',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactDotdotdot = __webpack_require__(156);
	...
	var About = function (_React$Component) {
	    ...
	    function About() {
	        ...
	        var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(About).call(this));
	    ...
	    (0, _createClass3.default)(About, [{
	        ...
	        key: 'setEllipse',
	        value: function setEllipse() {
	            var _this2 = this;

	            setTimeout(function () {
	                var para = (0, _jquery2.default)(window).height() - 425;
	                var temp = para.toString() + 'px';
	                _this2.setState({ para: temp });
	            }, 100);
	        }
	    }, {
	        key: 'changeFont',
	        value: function changeFont() {
	            if ((0, _jquery2.default)('.side').width() < 300) {
	                var fontSize = '12px';
	                (0, _jquery2.default)('#check').css('font-size', fontSize);
	            } else {
	                var _fontSize = '14px';
	                (0, _jquery2.default)('#check').css('font-size', _fontSize);
	            }
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'side', id: 'side' },
	                    _react2.default.createElement('img', { className: 'avatar', src: '/src/assets/img/me.png' }),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'desc' },
	                        _react2.default.createElement(
	                            _reactDotdotdot2.default,
	                            { clamp: this.state.para },
	                            _react2.default.createElement(
	                                'p',
	                                { id: 'check' },
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement('i', { className: 'icon ion-chevron-up' })
	                        ),
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'button-arrow' },
	                            _react2.default.createElement('i', { className: 'icon ion-chevron-down' })
	                        ),
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'button-arrow' },
	                            _react2.default.createElement('i', { className: 'icon ion-chevron-right' })
	                        )
	                    )
	                )
	            );
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(131)('getPrototypeOf', function($getPrototypeOf){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var clamp = __webpack_require__(117);
